    ...
    <div class="py-2 my-3 bg-white border row align-items-center">
        <div class="col-sm-6"> <span class="my-auto h6 page-headder">@yield('page-headder')</span>
            <ol class="bg-white breadcrumb">
                ...
                <li class="breadcrumb-item text-dark"><a href="{{ route('admin.transactions.index') }}">Transactions</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="p-0 bg-white card">
            <div class="py-3 card-header justify-content-between">
                <h4 class="float-start pt-2 card-title">Update Transactions</h4>
            </div>
            <div class="container p-4">

                @include('admin.transactions.partials.edit-form')
...
<script>
    $(document).ready(async function() {
        ...
        var baseUrl = `{{ url('api/v1/transactions') }}`;
