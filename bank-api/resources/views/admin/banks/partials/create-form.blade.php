<form method="POST" id="createbanksForm" action="{{ url('api/v1/banks') }}" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <div class="row">
...
<div class="mb-3 col-12 col-md-4 col-lg-3">
    <div class="form-group">
        ...
        <input type="text" name="fax" class="form-control @error('fax') is-invalid @enderror" value="{{ old('fax') }}" placeholder="Enter Fax..." id="create_fax" required>
        @error('fax')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
