    ...
    <td :colspan="colspan" class="text-center p-0">
      <div class="flex flex-col items-center justify-center w-full p-0">
        ...
        <template v-if="isLoading">
          ...
          bg-gray-100/50 dark:bg-gray-800/70 rounded-lg ">

            <div class="p-4 bg-gray-200 rounded -lg dark:bg-gray-800 flex flex-col items-center justify-center">
              <!-- Spinner -->
              <div
                class="relative shaqow bg-gray-200 dark:bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center">
          ...
          <div class="flex flex-col items-center justify-center py-12 px-6">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6 max-w-md">
              {{ emptyMessage || (hasSearch ?
                'No data match your search criteria.' : 'Get started by creating your first data.'
              ) }}
            </p>

            <!-- Action Buttons -->
            <div class="flex flex-col sm:flex-row gap-3">
              <button v-if="!hasSearch && showCreateButton" @click="$emit('create')"
              ...
              <button v-if="hasSearch && showClearButton" @click="$emit('clear-search')"
              ...
              <button v-if="showRefreshButton" @click="$emit('refresh')"
