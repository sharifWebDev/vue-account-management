<template>
  ...
  <div class="bg-white dark:bg-gray-800 p-3 rounded-lg dark:border dark:border-gray-700">
    ...
    <div v-if="bankStore.pagination.total > 0" class="mt-6">
      <Pagination v-if="bankStore.totalItems > 0" :total-items="bankStore.totalItems"
        :per-page="bankStore.perPage" :current-page="bankStore.currentPage" :last-page="bankStore.lastPage"
        :is-loading="bankStore.isLoading" @change-page="handlePageChange" @change-per-page="handlePerPageChange" />
    </div>
  </div>
