<template>
 ...
 <div class="bg-white dark:bg-gray-800 p-3 rounded-lg dark:border dark:border-gray-700">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 relative">
          <SortableTableHeader
            ...
            :sort-by="branchStore.sortBy"
            :sort-direction="branchStore.sortDirection"
          ...
          <TableLoadingState
            ...
            :is-loading="true"
            :total-items="branchStore.totalItems"
            :item-name="'branches'"
            loading-text="Loading deleted branches..."
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            <!-- Empty State -->
            <TableLoadingState
              v-if="branchStore.items.length === 0"
              :is-loading="false"
              :isEmpty="true"
              :has-search="!!searchQuery"
              :item-name="'deleted branches'"
    ...
    <div v-if="branchStore.totalItems > 0" class="mt-6">
      <Pagination
        :total-items="branchStore.totalItems"
        :per-page="branchStore.perPage"
        :current-page="branchStore.currentPage"
        :last-page="branchStore.lastPage"
        :is-loading="branchStore.loading"
  ...
  <BaseModal :show="showRestoreModal" title="Restore Branch" maxWidth="lg" @close="closeRestoreModal">
    <div class="px-6 py-3 text-center">
      ...
      <div class="flex justify-center space-x-3">
        <button @click="closeRestoreModal" :disabled="branchStore.loading" class="px-4 py-2 border rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
          Cancel
        </button>
        <button
          @click="handleRestore"
  ...
  <BaseModal :show="showPermanentDeleteModal" title="Permanently Delete Branch" maxWidth="lg" @close="closePermanentDeleteModal">
    <div class="px-6 py-3 text-center">
      ...
      <div class="flex justify-center space-x-3">
        <button @click="closePermanentDeleteModal" :disabled="branchStore.loading" class="px-4 py-2 border rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
          Cancel
        </button>
        <button
