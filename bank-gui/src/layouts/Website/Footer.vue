  ...
  <!-- Footer -->
    <footer class="bg-gray-800 text-white pt-16 pb-8">
        <div class="container mx-auto px-4">
            <div class="lg:max-w-[86rem] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        <div class="w-10 h-10 bg-gray-600 rounded-lg flex items-center justify-center shadow-md">
                            <i class="fas fa-cube text-white text-xl"></i>
                        </div>
                        <span class="text-xl font-bold">Banking<span class="text-gray-400">Pro</span></span>
                    </div>
                    <p class="text-gray-400 mb-6">Build custom business applications in minutes with our powerful platform. No coding required.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#packages" class="text-gray-400 hover:text-white transition">Packages</a></li>
            ...
            <div class="pt-8 border-t border-gray-700 text-center text-gray-400">
                <p>&copy; 2023 Banking Pro. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
